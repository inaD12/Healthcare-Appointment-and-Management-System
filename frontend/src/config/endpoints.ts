export const ENDPOINTS = {
  ...
  doctors: {
    ...
    meSpecialities: (doctorId?: string) => `/doctors-api/api/doctors/me/specialities`,
    scheduleWorkdays: (doctorId?: string) => `/doctors-api/api/doctors/me/schedule/workdays`,
    availabilityExtra: (doctorId?: string) => `/doctors-api/api/doctors/me/availability/extra`,
    availabilityUnavailable: (doctorId?: string) => `/doctors-api/api/doctors/me/availability/unavailable`,
  },
  appointments: {
