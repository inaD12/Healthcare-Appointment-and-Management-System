...
using Doctors.Application.Features.Doctors.Commands.RecommendSpeciality;
...
{
    public static RecommendSpecialityCommand ToCommand(
        this RecommendSpecialityRequest request)
        => new(
            request.Symptoms);
