...
namespace Ratings.Infrastructure.Features.Migrations
{
    /// <inheritdoc />
    public partial class Add_Database : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorRatingStats", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RateableAppointments", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RateableAppointments_Id",
                table: "RateableAppointments",
                column: "Id",
                unique: true);
